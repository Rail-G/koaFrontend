export default class ProductTable {
  ...
  init() {
    ...
    document
      .querySelector('table')
      .addEventListener('click', this.deleteData.bind(this));
    document
      .querySelector('table')
      .addEventListener('click', this.changeStatus.bind(this));
  ...
  async editData(e) {
    ...
    if (e.target.classList.contains('edit')) {
      this.current = [...e.target.closest('tr').querySelectorAll('td')].slice(
        1,
        3,
      );
  ...
  async addData(e) {
    ...
    document
      .querySelector('table tbody')
      .lastChild.querySelectorAll('td')[1]
      .addEventListener('click', this.currentTicket);
    this.closeBlock();
  }
